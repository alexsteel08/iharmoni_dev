                ...
                <div class="list_block_wrapper">
                    <?php if( have_rows('list_block') ): ?>
                        <div class="list_block">
                            <?php while( have_rows('list_block') ): the_row(); $selected = get_sub_field('modal'); $target = get_sub_field('target__blank'); ?>
                                <div class="list_block_item">
                                    <div class="list_block_content">
                                        ...
                                        <div class="list_block_btn">
                                            <a <?php if( in_array('target', $target) ) { echo 'target="_blank"'; } ?>  <?php if( in_array('modal', $selected) ) { echo 'class="trigger"'; } ?> href="<?php the_sub_field('button_link'); ?> "><?php the_sub_field('button_text'); ?> </a>
                                        </div>
                                    </div>
