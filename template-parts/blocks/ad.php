        ...
        <div class="ad_content content_width">
            <div class="ad_top">
                <?php if( get_sub_field('ad_title') && get_sub_field('ad_text') ): ?>
                    <div class="ad_title_text"  data-aos="fade-right" data-aos-delay="100" data-aos-offset="0" data-aos-once="true">
                        <div class="ad_title">
                ...
                <?php if( get_sub_field('ad_image') ): ?>
                   <div class="ad_image" data-da="ad_title_text,1,992"  data-aos="fade-left" data-aos-delay="200" data-aos-offset="0" data-aos-once="true">
            ...
            <?php if( have_rows('ad_cards') ): ?>
                <div class="ad_cards" data-aos="fade-up" data-aos-delay="100" data-aos-offset="0" data-aos-once="true">
