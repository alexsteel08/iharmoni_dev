        ...
        <div class="tech_content">
            <div class="tech_top">
                <?php if( get_sub_field('tech_title') && get_sub_field('tech_text') ): ?>
                    <div class="tech_top_left" data-aos="fade-up" data-aos-delay="100" data-aos-offset="0">
                ...
                <?php if( get_sub_field('tech_image') ): ?>
                   <div class="tech_image" data-da="tech_top_left,1,992" data-aos="fade-up" data-aos-delay="200" data-aos-offset="0">
            ...
            <div class="tech_bottom" data-aos="fade-up" data-aos-delay="300" data-aos-offset="0">
                ...
                <?php if( get_sub_field('image_section_2') ): ?>
                   <div class="image_section_2" data-da="tech_bottom_first,2,992" data-aos="fade-up" data-aos-delay="400" data-aos-offset="0">
                ...
                <?php if( have_rows('tech_cards') ): ?>
                    <div class="tech_cards" data-aos="fade-up" data-aos-delay="500" data-aos-offset="0">
